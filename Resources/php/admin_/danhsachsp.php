...
$sql = "SELECT * FROM `product` WHERE `Name` LIKE '%$searchTerm%' LIMIT $perRow, $rowsPerPage";
    ...
    <div>
        ...
        <div class="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            ...
            <div class="mt-4 flex sm:mt-0 sm:ml-4">
                <a href="quantri.php?page_layout=themsp" class="items-center truncate hover:text-sky-600 dark:hover:text-sky-400">
                    <button class="btn btn-primary block w-full order-0 sm:order-1">
                        Thêm sản phẩm
                    </button>
                </a>
            </div>
        ...
        <div class="p-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                                        ...
                                        ?>
                                            <tr class="relative hover:bg-slate-50 dark:hover:bg-slate-800/75">
                                                ...
                                                <td class="relative px-3 py-4 font-medium text-sm text-slate-900 text-left whitespace-nowrap dark:text-slate-200">
                                                    <div class="flex items-center">
                                                        <div class="h-10 w-10 flex-shrink-0">
                                                            <img class="h-10 w-10 rounded object-center object-cover" src="<?php echo $row['Image']; ?>" alt="Xiaomi 12 Pro">
                                                        </div>
                                                        <div class="ml-4">
                                                            <a href="quantri.php?page_layout=suasp&Id=<?php echo $row['Id']; ?>" class="inline-flex items-center truncate hover:text-sky-600 dark:hover:text-sky-400">
                                                                <span>
                                                                    <?php echo $row['Name']; ?>
                                                                </span>
                                                            </a>
                                                ...
                                                <td class="pl-3 pr-4 py-4 text-left text-sm text-slate-500 whitespace-nowrap sm:pr-6 dark:text-slate-400">
                                                    <?php echo number_format($row['Price'] / 1, 0, ',', '.') . ' đ'; ?>
                                                </td>
                                                <td class="pl-3 pr-4 py-4 text-left text-sm text-slate-500 whitespace-nowrap sm:pr-6 dark:text-slate-400">
            ...
            for ($i = 1; $i <= $totalPage; $i++) {
                if ($i == $page) {
                    ...
                    $listPage .= ' <a href="' . $_SERVER['PHP_SELF'] . '?page=' . $i . '&page_layout=danhsachsp&search=' . $searchTerm . '">' . $i . '</a> ';
                }
            }
            ?>
            <p id="pagination">
                ...
                <div>
                    <nav role="navigation" class="flex items-center justify-between">
                        <div class="flex justify-between flex-1 sm:hidden">
                            <span>
                                <a href="<?php echo $page > 1 ?  $_SERVER['PHP_SELF'] . '?page_layout=danhsachsp&search=' . $searchTerm . '' . '&page=' . ($page - 1) : 'javascript:void(0)'; ?>" <?php echo $page == $totalPage ? 'role="link" aria-disabled="true"' : ''; ?>>
                            ...
                            <span> <a href="<?php echo $page < $totalPage ?  $_SERVER['PHP_SELF'] . '?page_layout=danhsachsp&search=' . $searchTerm . '' . '&page=' . ($page + 1) : 'javascript:void(0)'; ?>" <?php echo $page == $totalPage ? 'role="link" aria-disabled="true"' : ''; ?>>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-end gap-6">
                            ...
                            <div>
                                <span>
                                    <a href="<?php echo $page > 1 ?  $_SERVER['PHP_SELF'] . '?page_layout=danhsachsp&search=' . $searchTerm . '' . '&page=' . ($page - 1) : 'javascript:void(0)'; ?>">
                                        <button type="button" class="btn btn-default" <?php echo $page == 1 ? 'disabled' : ''; ?>>
                                            « Trước
                                        </button>
                                    </a>
                                ...
                                <span>
                                    <a href="<?php echo $page < $totalPage ?  $_SERVER['PHP_SELF'] . '?page_layout=danhsachsp&search=' . $searchTerm . '' . '&page=' . ($page + 1) : 'javascript:void(0)'; ?>">
                                        <button type="button" class="ml-3 btn btn-default" <?php echo $page == $totalPage ? 'disabled' : ''; ?>>
                                            Sau »
                                        </button>
                                    </a>
