...
WHERE (orders.id LIKE '%$searchTerm%' OR name LIKE '%$searchTerm%' OR address LIKE '%$searchTerm%' OR phone = '$searchTerm') AND shipping_status = 'Chờ xác nhận'
        ...
        <div class="p-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="px-4 py-5 rounded-t-md sm:px-6 sm:rounded-t-lg">
                    <div class="relative max-w-sm text-slate-400 focus-within:text-slate-600 dark:focus-within:text-slate-200">
                        ...
                        <form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <input type="hidden" name="page_layout" value="wait">
            ...
            for ($i = 1; $i <= $totalPage; $i++) {
                if ($i == $page) {
                    ...
                    $listPage .= ' <a href="' . $_SERVER['PHP_SELF'] . '?page=' . $i . '&page_layout=wait&search=' . $searchTerm . '">' . $i . '</a> ';
                }
            }
            ?>
            <p id="pagination">
                ...
                <div>
                    <nav role="navigation" class="flex items-center justify-between">
                        <div class="flex justify-between flex-1 sm:hidden">
                            <span>
                                <a href="<?php echo $page > 1 ?  $_SERVER['PHP_SELF'] . '?page_layout=wait&page=' . ($page - 1) : 'javascript:void(0)'; ?>" <?php echo $page == $totalPage ? 'role="link" aria-disabled="true"' : ''; ?>>
                            ...
                            <span> <a href="<?php echo $page < $totalPage ?  $_SERVER['PHP_SELF'] . '?page_layout=wait&search=' . $searchTerm . '' . '&page=' . ($page + 1) : 'javascript:void(0)'; ?>" <?php echo $page == $totalPage ? 'role="link" aria-disabled="true"' : ''; ?>>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-end gap-6">
                            ...
                            <div>
                                ...
                                <span>
                                    <a href="<?php echo $page < $totalPage ?  $_SERVER['PHP_SELF'] . '?page_layout=wait&search=' . $searchTerm . '' . '&page=' . ($page + 1) : 'javascript:void(0)'; ?>">
                                        <button type="button" class="ml-3 btn btn-default" <?php echo $page == $totalPage ? 'disabled' : ''; ?>>
                                            Sau »
                                        </button>
                                    </a>
